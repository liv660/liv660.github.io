...
<div class="slider-box">
  <ul class="slider">
    <li>
      <div class="slide-name">[`반려동물찾기`, '유기동물발견'' 게시판의 글쓰기 페이지 구현]</div>
      <img src="https://user-images.githubusercontent.com/73643995/117130219-b79e1b00-adda-11eb-905d-250b8435e272.jpg" />
      <div class="slide-detail">
        <div>`commons-fileupload`, `commons-io`, `ojdbc6`, `Naver 스마트에디터` 라이브러리 사용</div>
        <div>파일(사진) 업로드 및 미리보기 기능 구현</div>
        <div>`javascript`, `jQuery` 로 파일 유효검사 기능 구현 (확장자, 크기, 개수 등)</div>
      </div>
    </li>
  </ul>
</div>
