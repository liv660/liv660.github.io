...
# 📝21.05.20 TIL
+ 백준 알고리즘 [11720](https://www.acmicpc.net/problem/11720), [11809](https://www.acmicpc.net/problem/10809) 풀이 완료

  + 내가 푼 110809 풀이 (메모리 15.8MB, 시간 148ms로 통과)<br />
...
<br />
  ...
  + 통과는 했으나 더 좋은 방법이 분명 있을 것 같아서 바로 풀이를 찾아보았다. 아래는 [풀이코드](https://st-lab.tistory.com/62)이다. (메모리 15.8MB, 시간 144ms로 통과)<br />
